...
ODnew$total_consumption <- rowSums(ODnew[, c("ricepds_v", "Wheatpds_q", "chicken_q", "pulsep_q", "wheatos_q")], na.rm = TRUE)
...
ODnew$District <- ifelse(ODnew$District %in% names(district_mapping), district_mapping[ODnew$District], ODnew$District)
ODnew$Sector <- ifelse(ODnew$Sector %in% names(sector_mapping), sector_mapping[ODnew$Sector], ODnew$Sector)
